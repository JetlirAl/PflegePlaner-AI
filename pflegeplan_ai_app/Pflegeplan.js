...
function Pflegeplan() {
  ...
  return (
    <div>
      ...
      <textarea placeholder="Pflegebedarf" value={bedarf} onChange={e => setBedarf(e.target.value)} rows={4} style={{ width: '100%', marginTop: '0.5rem' }} /><br />
      <button onClick={exportAsPDF} style={{ marginTop: '1rem' }}>Als PDF exportieren</button>
    </div>
  );
}
